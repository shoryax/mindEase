        ...
        <div className="max-w-6xl mx-auto px-6 lg:px-8 py-10">
          <div className="space-y-8">
            <div className="text-center mb-12">
              <a href="/" className="inline-flex items-center gap-2 text-white/60 hover:text-white transition-colors mb-6">
            ...
            <div className="flex flex-col items-center gap-4 pt-6">
              <Button
                size="lg"
                className="bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white rounded-full px-12 h-14 text-base border-0 font-light"
              >
                Save All Settings
              </Button>
            </div>
