      ...
      <div className="max-w-7xl mx-auto">
        <div className="max-w-4xl">
          ...
          <h1 className="text-7xl lg:text-8xl font-light leading-[0.95] mb-8 tracking-tight">
            healing starts
            <br />
            <span className="italic pr-4 font-serif text-transparent bg-clip-text bg-gradient-to-r from-[#0A2F47] via-[#2F5872] to-[#5A87A3]">
              with connection
            </span>
          </h1>
          ...
          <div className="flex items-center gap-6">
            <Button size="lg" className="bg-gradient-to-r from-[#0C3A53] to-[#3590ce] hover:from-[#0A2F47] hover:to-[#0c6eab] text-white rounded-full px-10 h-14 text-base border-0">
              Start Your Journey
            </Button>
